...
export DIGI_CONFIG="--digi-config-file=${GITHUB_WORKSPACE}/data/odd-digi-smearing-config.json"
...
export SEEDING_CONFIG="--geo-selection-config-file=${GITHUB_WORKSPACE}/data/odd-seeding-config.json"
